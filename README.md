About airflow-config-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/airflow-config-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/airflow-config-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add airflow-config
# for installing globally
pixi global install airflow-config
```
...
It is possible to list all of the versions of `airflow-config` available on your platform:
...
```
pixi search airflow-config --channel conda-forge
```
